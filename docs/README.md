...
| [`src/logicxkit/data/README.md`](../src/logicxkit/data/README.md) | The record templates and native donors the package ships, where each came from, and which `bin/regen_data.py` regenerates |
